-- CONSIGNE JOB 5 requête permettant de sélectionner le prenom, le nom et la date de naissance des étudiants de sexe féminin

-- SELECT prenom, nom, naissance = colonnes qui s'affiche
-- FROM etudiants =  dans la table etudiants
-- WHERE sexe = 'Femme' = uniquement les étudiantes
-- Requête : 
