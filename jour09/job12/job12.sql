-- CONSIGNE JOB 12 permet de sélectionner la somme des capacités des salles.

-- ORDER BY capacite DESC = ordre décroissant
-- SELECT * = affiches toutes les colonnes de la table salles
-- ORDER BY capacite = demandes un tri en fonction de la colonne "capacite"
