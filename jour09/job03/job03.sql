-- * = toutes les colonnes, etudiants = le nom de la table
-- en SQL 1 est considéré comme vrai, donc WHERE 1 veut dire
-- "toutes les lignes" parce que la condition est toujours vraie

-- JOB 3 requête dessous permettant de sélectionner l’ensemble des champs de la table etudiants: 
