-- CONSIGNE JOB 15 permet de récupérer le nom des salles et le nom de leur étage.

-- Requête :
-- sélectionne le nom de la salle et le nom de son étage
SELECT salles.nom, etage.nom 
-- depuis les tables salles et etage 
FROM salles, etage 
-- liaison l’id de l’étage dans "salles" correspond à l’id de "etage"
