-- CONSIGNE JOB 14 permet de sélectionner le prenom, le
-- nom et la date de naissance des étudiants qui sont nés entre 1998 et 2018.

-- Requête :
-- sélectionne le prénom, le nom et la date de naissance des étudiants
-- depuis la table "etudiants"
SELECT prenom, nom, naissance FROM etudiants 
-- garde que ceux dont la date de naissance est entre le 1998-01-01' et '2018-12-31'
