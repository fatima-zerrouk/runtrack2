-- CONSIGNE JOB 6 requête permettant de sélectionner l’ensemble des informations des étudiants dont prenom commence par un “T”

-- Requête : 
-- LIKE 'T%' rechercher tout ce qui commence par T
