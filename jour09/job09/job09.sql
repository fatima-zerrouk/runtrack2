-- CONSIGNE JOB 9 permet de sélectionner l’ensemble des informations des étudiants qui ont moins de 18 ans.

-- TIMESTAMPDIFF(YEAR, naissance, CURDATE()) =  calcule la différence en années entre la date de naissance (naissance) et la date actuelle (CURDATE())
-- < 18 = tu ne gardes que ceux qui ont moins de 18 ans
-- Requête : 
